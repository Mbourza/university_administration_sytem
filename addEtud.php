...
<form action="" method="post" enctype="multipart/form-data" id="addEtud">
	...
	<div class="field">
		<input type="text" class="form-control" name="name" placeholder="Etud Name here..." id="numInput"/>
	</div>

	<div class="field">
	    <input type="text" class="form-control" name="lname" placeholder="Etud Last Name here..." id="lnumInput"/>
	</div>

	<div class="field">
	   <input type="email" class="form-control" name="memb_email" placeholder="Etud Email here..." id="eInput"/>	
	</div>

	<div class="field">
	    <input type="text" class="form-control" name="memb_code" placeholder="Etud Code here..." id="coInput"/>	
	</div>

	<div class="field">
	   <input type="text" class="form-control" name="ddnetud" placeholder="Etud Date De Naissance here..." id="dnInput"/>
	</div>
    <div class="field">
